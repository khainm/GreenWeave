      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            {isLoading ? (
              <div className="h-5 w-32 bg-indigo-200 rounded animate-pulse mt-1"></div>
            ) : (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg border-2 border-purple-100 p-6">
            ...
            <div className="max-w-sm mx-auto">
              {isLoading ? (
                <div className="bg-white border-2 border-indigo-200 rounded-xl overflow-hidden shadow-md animate-pulse">
                  <div className="h-64 bg-gradient-to-br from-indigo-100 to-purple-100"></div>
