          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-blue-800">
                <p className="font-semibold mb-1">💡 Đơn hàng được xử lý tự động</p>
                <p>Đơn COD và thanh toán qua PayOS sẽ tự động xác nhận và tạo vận đơn. Bạn sẽ nhận email với mã tracking để theo dõi.</p>
              </div>
            </div>
          </div>
