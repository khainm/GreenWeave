  ...
  return (
    <tr className="hover:bg-gray-50 transition-colors">
      ...
      <td className="py-4 px-6 text-gray-900 font-bold">
        {product.price ? `${formatVnd(product.price)} đ` : (
      ...
      <td className="py-4 px-6 text-right">
        <div className="flex items-center justify-end gap-2">
          <Link 
            ...
            className={`${productType === 'custom' 
              ? 'bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700' 
              : 'bg-green-600 hover:bg-green-700'
            } text-white px-4 py-2 rounded-lg text-sm font-medium transition-all shadow-sm hover:shadow-md flex items-center gap-1`}
          >
            {productType === 'custom' && (
